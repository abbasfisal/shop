...
type MongoProductRecommendation struct {
	ID      primitive.ObjectID    `bson:"_id,omitempty"`
	Product RecommendationProduct `bson:"product"`
...
type RecImg struct {
	Data []RecImgData `bson:"Data"`
}

type RecImgData struct {
