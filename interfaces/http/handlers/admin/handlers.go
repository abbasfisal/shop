...
func (a *AdminHandler) ShowHome(c *gin.Context) {
	...
	response.Render(c, http.StatusOK, "modules/admin/html/admin_home", gin.H{
		"TITLE": "داشبورد",
		"DATA":  data,
	})
	return
...
func (a *AdminHandler) ProductsAddAttributes(c *gin.Context) {
	...
	response.Render(c, 200, "admin_create_product_att_values", gin.H{
...
func (a *AdminHandler) ShowProductInventory(c *gin.Context) {
	...
	response.Render(c, 200, "inventory", gin.H{
...
func (a *AdminHandler) UpdateQuantity(c *gin.Context) {
	...
	if bindErr != nil {
		sessions.Set(c, "UPDATEMESSAGE", domain_err.SomethingWrongHappened)
