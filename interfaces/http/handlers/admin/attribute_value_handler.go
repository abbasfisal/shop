...
func (a *AdminHandler) IndexAttributeValues(c *gin.Context) {
	...
	response.Render(c, 200, "admin_index_attribute_value", gin.H{
...
func (a *AdminHandler) ShowAttributeValues(c *gin.Context) {
	...
	response.Render(c, 200, "admin_show_attribute_values_index", gin.H{
...
func (a *AdminHandler) EditAttributeValues(c *gin.Context) {
	...
	response.Render(c, 200, "admin_show_attribute_values_edit", gin.H{
