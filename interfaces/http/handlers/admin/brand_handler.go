...
func (a *AdminHandler) ShowCreateBrand(c *gin.Context) {
	response.Render(c, 200, "create-brand", gin.H{"TITLE": "ایجاد برند"})
	return
}
...
func (a *AdminHandler) IndexBrand(c *gin.Context) {
	...
	response.Render(c, 200, "modules/admin/html/admin_index_brand", gin.H{
		"TITLE":  "لیست برند ها",
		"BRANDS": brands,
	})
	return
...
func (a *AdminHandler) ShowBrand(c *gin.Context) {
	...
	response.Render(c, http.StatusOK, "show-brand", gin.H{
		"TITLE":    "نمایش برند",
		"BRAND_ID": brandID,
		"BRAND":    brand,
	})
