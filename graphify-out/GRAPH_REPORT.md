...
## Corpus Check
- 568 files · ~2,804,467 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1816 nodes · 3038 edges · 189 communities (100 shown, 89 thin omitted)
- Extraction: 91% EXTRACTED · 9% INFERRED · 0% AMBIGUOUS · INFERRED: 260 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f56e8599`
...
1. `HomeRepository` - 32 edges
2. `New()` - 31 edges
3. `ProductService` - 28 edges
4. `HomeService` - 26 edges
5. `AdminHandler` - 26 edges
6. `CustomError` - 24 edges
7. `SyncReadModel()` - 22 edges
8. `AdminLTE Page Skeleton Contract (head / navbar / sidebar / footer sub-templates + content-wrapper)` - 21 edges
9. `HandleError()` - 19 edges
...
- `newIntentRouter()` --calls--> `New()`  [INFERRED]
  interfaces/http/middleware/customer_must_loggin_test.go → domain/domain_err/custom_error.go
...
### Community 0 - "seeder.go"
Cohesion: 0.13
Nodes (22): Category, Model, Product, Time, SliderPositionLabel(), SliderPositions(), ValidSliderPosition(), ProductSlider (+14 more)

### Community 1 - "Product"
Cohesion: 0.08
Nodes (38): Product, ProductInventories, ProductInventory, Products, VariantAttributeValue, availableOf(), Time, ToProductInventories() (+30 more)
...
### Community 3 - "customer_must_loggin.go"
Cohesion: 0.09
Nodes (26): Duration, Engine, Context, PublicHandler, Context, PublicHandler, CheckCustomerSessionID(), HandlerFunc (+18 more)
...
Cohesion: 0.11
Nodes (13): Context, CustomerProfileRequest, CustomerVerifyRequest, IncreaseCartItemQty, Order, OTP, Pagination, Payment (+5 more)
...
Cohesion: 0.07
Nodes (46): Address, AdminOrder, AdminOrderItem, AdminOrderItems, AdminOrders, Customer, Customers, Order (+38 more)
...
Cohesion: 0.07
Nodes (29): ProductListQuery, Context, NewPricingService(), Context, T, TestRefreshProductAggregates_DelegatesToRepository(), TestRefreshProductAggregates_PropagatesError(), Context (+21 more)
...
Cohesion: 0.05
Nodes (41): Client, New(), T, TestHandleError_InternalError(), TestHandleError_RecordNotFound(), TestNewAndError(), HomeRepository, Context (+33 more)
...
Cohesion: 0.08
Nodes (27): BannerService, FeeRateService, HomeServiceInterface, AddToCartRequest, Context, HomeServiceInterface, T, postAddToCart() (+19 more)

### Community 16 - "customer_order_response.go"
Cohesion: 0.09
Nodes (37): CustomerOrderStatusMap(), AttributeValue, Order, OrderItemAttribute, OrderItemAttributes, Time, VariantAttributeValue, ToAddress() (+29 more)
...
Cohesion: 0.24
Nodes (12): Feature, attributeValueHex(), derefUint(), derefUintToInt64(), Context, DB, JSON, Product (+4 more)

### Community 20 - "product_slider_response.go"
Cohesion: 0.18
Nodes (12): ProductSlider, ProductSliders, SliderPosition, SliderProduct, SliderPositions(), SlidersByPosition(), ToSlider(), ToSliderProduct() (+4 more)

### Community 21 - "methods.go"
Cohesion: 0.11
Nodes (20): Context, IsAdmin(), CheckUserAuth(), HandlerFunc, Context, IsGuest(), Auth(), CustomerAuth() (+12 more)
...
### Community 28 - "NewFeeRateRepository"
Cohesion: 0.22
Nodes (7): NewFeeRateService(), DB, NewFeeRateRepository(), Dependencies, Engine, SetAdminRoutes(), FeeRateRepositoryInterface

### Community 29 - "OrderRepository"
Cohesion: 0.20
Nodes (9): Customer, Context, DB, NewOrderRepository(), Order, OrderRepository, OrderRepositoryInterface, Pagination (+1 more)
...
Cohesion: 0.08
Nodes (22): Brand, checkIDAndExistence(), AdminHandler, Context, AdminHandler, Context, AllowImageExtensions(), formatWithCommas() (+14 more)

### Community 33 - "zarinpal.go"
Cohesion: 0.06
Nodes (30): Bundle, MyError, NewZarinpal(), SendSuccShop(), Context, PublicHandler, Context, PublicHandler (+22 more)

### Community 34 - "Context"
Cohesion: 0.24
Nodes (5): CreateProductFeatureRequest, UpdateProductFeatureRequest, Context, Feature, ProductRepository

### Community 35 - ".insertCartItem"
Cohesion: 0.27
Nodes (5): cartSelectionMessage(), AddToCartRequest, Product, menuFromCache(), CategoryResponse
...
Cohesion: 0.12
Nodes (13): CreateCategoryRequest, LoginRequest, Context, User, Category, Context, Context, Category (+5 more)

### Community 40 - "setupRoutes"
Cohesion: 0.36
...
Cohesion: 0.30
Nodes (6): Context, FeeRate, Time, QuoteAt(), FeeQuote, FeeRateService
...
### Community 48 - "Render"
Cohesion: 0.08
Nodes (30): Banner, Banners, ToBanner(), ToBanners(), Context, BannerLayoutLabel(), BannerTypeLabel(), Time (+22 more)
...
### Community 51 - "FeeRateRepository"
Cohesion: 0.40
...
### Community 64 - "fee_repository_test.go"
Cohesion: 0.39
...
### Community 123 - "SetPublic"
Cohesion: 0.20
Nodes (8): Dependencies, EventManager, NewHomeService(), Dependencies, Engine, EventManager, SetPublic(), HomeRepositoryInterface
...
## Knowledge Gaps
- **46 isolated node(s):** `variantJSON`, `AdminHandler`, `Layout & dependency direction`, `Commands`, `Gotchas` (+41 more)
...
- **Why does `New()` connect `HomeRepository` to `zarinpal.go`, `EventManager`, `customer_must_loggin.go`, `HomeService`, `CustomError`, `ProductService`, `ZapLogger`, `BrandService`, `Storage`?**
  _High betweenness centrality (0.197) - this node is a cross-community bridge._
- **Why does `NewHomeRepository()` connect `HomeRepository` to `T`, `EventManager`, `SetPublic`?**
  _High betweenness centrality (0.156) - this node is a cross-community bridge._
- **Why does `SetPublic()` connect `SetPublic` to `setupRoutes`, `NewFeeRateRepository`, `HomeRepository`, `PublicHandler`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Are the 28 inferred relationships involving `New()` (e.g. with `.ProcessTask()` and `TestRefreshProductAggregates_PropagatesError()`) actually correct?**
